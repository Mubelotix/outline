# This fork allows authentication based on a header-value (you set with your proxy)

Outline devs believe you don't need this feature. If you want it merged to outline, support [#7758](https://github.com/outline/outline/pull/7758)
